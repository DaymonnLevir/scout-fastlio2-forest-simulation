...
start_all() {
    ...
    create_window         "spawn"         "cd '$ROS_WS'; ros2 run ros_gz_sim create         -world '$WORLD'         -file '$ROBOT_URDF'         -name scout_mini         -x -6 -y 2 -z 0.6;         echo;         echo 'Scout inserido no mundo.';         exec bash"
    ...
    create_window "ground_truth" "ros2 run ros_gz_bridge parameter_bridge '/ground_truth/odom_raw@nav_msgs/msg/Odometry[ignition.msgs.Odometry' --ros-args -r __node:=bridge_ground_truth"
